...
public class UsersResourceTest extends AbstractRestApiModuleTest {
    private static final String getMethod = "GET";

    private RealmResource getTestRealm() {
    	return this.getRealm("test");
    }
    ...
    public void testGetUsersWithGroup() throws IOException, URISyntaxException {
    	RealmResource testRealm = getTestRealm();
        List<NameValuePair> nvps = new ArrayList<>();
